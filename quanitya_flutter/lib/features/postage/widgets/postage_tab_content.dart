...
/// Generic layout shell for postage tabs.
///
/// Provides a consistent structure: optional banner at top,
/// expanded content area in the middle, and optional bottom actions.
/// Each postage tab (Feedback, Analytics, Errors) plugs its specific
/// widgets into these slots.
class PostageTabContent extends StatelessWidget {
...
/// Reusable privacy banner used across postage tabs.
class PostagePrivacyBanner extends StatelessWidget {
  final String text;

  const PostagePrivacyBanner({super.key, required this.text});
...
/// Reusable empty state for postage tabs.
class PostageEmptyState extends StatelessWidget {
  final IconData icon;
  final Color? iconColor;
  final String title;
  final String description;

  const PostageEmptyState({
    super.key,
    required this.icon,
    this.iconColor,
    required this.title,
