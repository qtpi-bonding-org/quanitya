...
part 'notification_inbox_cubit.freezed.dart';

@injectable
class NotificationInboxCubit extends QuanityaCubit<NotificationInboxState> {
  final NotificationRepository _repository;
  StreamSubscription? _subscription;
  
  NotificationInboxCubit(this._repository) 
...
@freezed
class NotificationInboxState with _$NotificationInboxState implements IUiFlowState {
  const factory NotificationInboxState({
