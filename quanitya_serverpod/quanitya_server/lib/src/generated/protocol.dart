...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i15.MonthlyBackupFutureCallRunMonthlyBackupModel) {
      return _i15.MonthlyBackupFutureCallRunMonthlyBackupModel.fromJson(data)
          as T;
    }
    if (t == _i16.Greeting) {
    ...
    if (t ==
        _i1.getType<_i15.MonthlyBackupFutureCallRunMonthlyBackupModel?>()) {
      return (data != null
              ? _i15.MonthlyBackupFutureCallRunMonthlyBackupModel.fromJson(data)
              : null)
          as T;
    }
  ...
  static String? getClassNameForType(Type type) {
    return switch (type) {
      ...
      _i15.MonthlyBackupFutureCallRunMonthlyBackupModel =>
  ...
  String? getClassNameForObject(Object? data) {
    ...
    switch (data) {
      ...
      case _i15.MonthlyBackupFutureCallRunMonthlyBackupModel():
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'MonthlyBackupFutureCallRunMonthlyBackupModel') {
      return deserialize<_i15.MonthlyBackupFutureCallRunMonthlyBackupModel>(
        data['data'],
      );
    }
