...
import 'package:quanitya_server/src/generated/archived_month.dart' as _i4;
import 'package:quanitya_server/src/generated/archive_metadata.dart' as _i5;
import 'package:quanitya_server/src/generated/archive_search_result.dart'
    as _i6;
import 'package:serverpod_auth_core_server/serverpod_auth_core_server.dart'
    as _i7;
import 'package:quanitya_server/src/generated/powersync_token.dart' as _i8;
...
class _ArchiveEndpoint {
  ...
  _i3.Future<_i4.ArchivedMonth?> getArchivedMonth(
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'archive',
            method: 'getArchivedMonth',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'archive',
          methodName: 'getArchivedMonth',
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i4.ArchivedMonth?>);
  ...
  _i3.Future<List<_i4.ArchivedMonth>> getArchivedDateRange(
    _i1.TestSessionBuilder sessionBuilder,
    int startYear,
    int startMonth,
    int endYear,
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'archive',
            method: 'getArchivedDateRange',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'archive',
          methodName: 'getArchivedDateRange',
          parameters: _i1.testObjectToJson({
            'startYear': startYear,
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<List<_i4.ArchivedMonth>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Future<_i5.ArchiveMetadata> getArchiveMetadata(
    _i1.TestSessionBuilder sessionBuilder,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i5.ArchiveMetadata>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Future<List<_i6.ArchiveSearchResult>> searchArchivedEntries(
    _i1.TestSessionBuilder sessionBuilder,
    DateTime startDate,
    DateTime endDate,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'archive',
            method: 'searchArchivedEntries',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'archive',
          methodName: 'searchArchivedEntries',
          parameters: _i1.testObjectToJson({
            'startDate': startDate,
            'endDate': endDate,
          }),
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<List<_i6.ArchiveSearchResult>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Future<String> runManualArchival(
    _i1.TestSessionBuilder sessionBuilder,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'archive',
            method: 'runManualArchival',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'archive',
          methodName: 'runManualArchival',
          parameters: _i1.testObjectToJson({}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
...
class _PowerSyncEndpoint {
  ...
  _i3.Future<_i8.PowerSyncToken> getToken(
    _i1.TestSessionBuilder sessionBuilder,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i8.PowerSyncToken>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
...
class _SyncEndpoint {
  ...
  _i3.Future<_i9.EncryptedTemplate> upsertEncryptedTemplate(
    _i1.TestSessionBuilder sessionBuilder,
    String id,
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'sync',
            method: 'upsertEncryptedTemplate',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'sync',
          methodName: 'upsertEncryptedTemplate',
          parameters: _i1.testObjectToJson({
            'id': id,
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i9.EncryptedTemplate>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Future<bool> deleteEncryptedTemplate(
    _i1.TestSessionBuilder sessionBuilder,
    String id,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'sync',
            method: 'deleteEncryptedTemplate',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'sync',
          methodName: 'deleteEncryptedTemplate',
  ...
  _i3.Future<_i10.EncryptedEntry> upsertEncryptedEntry(
    _i1.TestSessionBuilder sessionBuilder,
    String id,
    String encryptedData,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'sync',
            method: 'upsertEncryptedEntry',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'sync',
          methodName: 'upsertEncryptedEntry',
          parameters: _i1.testObjectToJson({
            'id': id,
            'encryptedData': encryptedData,
          }),
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i10.EncryptedEntry>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Future<bool> deleteEncryptedEntry(
    _i1.TestSessionBuilder sessionBuilder,
    String id,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'sync',
            method: 'deleteEncryptedEntry',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'sync',
          methodName: 'deleteEncryptedEntry',
          parameters: _i1.testObjectToJson({'id': id}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
  ...
  _i3.Future<_i11.EncryptedSchedule> upsertEncryptedSchedule(
    _i1.TestSessionBuilder sessionBuilder,
    String id,
    String encryptedData,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'sync',
            method: 'upsertEncryptedSchedule',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'sync',
          methodName: 'upsertEncryptedSchedule',
          parameters: _i1.testObjectToJson({
            'id': id,
            'encryptedData': encryptedData,
          }),
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i11.EncryptedSchedule>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Future<bool> deleteEncryptedSchedule(
    _i1.TestSessionBuilder sessionBuilder,
    String id,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'sync',
            method: 'deleteEncryptedSchedule',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'sync',
          methodName: 'deleteEncryptedSchedule',
          parameters: _i1.testObjectToJson({'id': id}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
...
class _MonthlyBackupFutureCall {
  Future<void> runMonthlyBackup(
    ...
    var object = _i16.MonthlyBackupFutureCallRunMonthlyBackupModel(
      iteration: iteration,
    );
  ...
  Future<void> initializeSchedule(
    ...
    var object = _i18.MonthlyBackupFutureCallInitializeScheduleModel(
      iteration: iteration,
    );
    var _localUniqueSession = (sessionBuilder as _i1.InternalTestSessionBuilder)
        .internalBuild();
